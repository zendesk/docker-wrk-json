...
requests = load_request_objects_from_file("/data/page_view.requests.json")
...
request = function()
  ...
  local json_text = cjson.encode(request_object.body)

  -- Return the request object with the current URL path
  return wrk.format(request_object.method, request_object.path, request_object.headers, json_text)
end
